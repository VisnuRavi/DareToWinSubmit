...
def gamestart(update, context):
    ...
    if start_state is True and players_assembled is False:
        if len(players) == 1:
            ...
            update.message.reply_text('Enter /finddare to get a dare from our dare pool!')
...
def main():
    ...
    #dp.add_handler(CommandHandler('acceptfinddare', accept_find_dare))
