...
def resetpassreq():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('login')) 
    return render_template('resetpassreq.html', form = form)
...
def new_reports():
    ...
    return render_template('new_reports.html', reports = reports.items, form = form, prev_url = prev_url, next_url = next_url)
